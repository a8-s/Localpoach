...
app.use('/js', express.static( __dirname + '/public/assets/bootstrap/'));
app.use('/css', express.static( __dirname + '/public/assets/bootstrap/'));
app.use('/css', express.static( __dirname + '/public/assets/'));
app.use('/fonts', express.static( __dirname + '/public/assets'));
